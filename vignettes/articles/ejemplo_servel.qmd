...
description: Limpieza de datos comunales de afiliaciones a partidos políticos según género, obtenidos desde el Servel mediante solicitud de transparencia.
knitr:
  opts_chunk:
    collapse: true
    comment: '#>'
...
Puedes [descargar aquí los datos](https://github.com/bastianolea/territorial/raw/main/data-raw/ejemplo_servel_partidos.xlsx) para seguir el ejemplo.
