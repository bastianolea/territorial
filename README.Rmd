...
Si tenemos datos de nivel comunal pero les faltan variables territoriales, podemos _contextualizar_ los datos territoriales al agregarles todas las variables que les faltan con la función `contextualizar()`:
